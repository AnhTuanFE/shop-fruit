...
const renderError = (errors: any) => {
  const message = errors.find((error: any) => error?.error)?.message;
  if (message)
    return (
    ...
    <>
      <div>
        <div className="row col-lg-12 mt-2 flex items-center justify-center pb-14 max-sm:mx-4">
          ...
          >
            <div className="mb-3 mt-2 text-center text-xl font-semibold">
              {" "}
              Đăng ký tài khoản
            </div>
            <div className=" ">
            ...
            <p className=" mt-3 text-center">
              <Link to={"/login"}>
                Đã có tài khoản{" "}
                <strong className="text-lg text-blue-600 hover:text-red-500">
                  Đăng nhập
                </strong>
              </Link>
            </p>
